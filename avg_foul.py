...
data['HomeReds_Discrete'] = pd.qcut(data['HomeReds'], q=3, labels=['LowHomeReds', 'MediumHomeReds', 'HighHomeReds'], duplicates='drop')
data['AwayReds_Discrete'] = pd.qcut(data['AwayReds'], q=3, labels=['LowAwayReds', 'MediumAwayReds', 'HighAwayReds'], duplicates='drop')
